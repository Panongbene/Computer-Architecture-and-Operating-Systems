...
int func5(int x) 
    {
       int kk=((((0x55<<8)|(0x55))<<16)|((0x55<<8)|(0x55)));//01010101 ..... 010101
	   return !((kk&x)^kk);
    }
/*************************************************************************************************/
/* 
 ...
 *   Examples: func6(0x87654321,4) = 0x8765432
 *   Legal ops: ! ~ & ^ | + << >>
 *   Max ops: 20
 *   Rating: 3 
 */
...
int func6(int x, int n) 
    {
      return ((x&( (~(1<<31)))/*0x7fffffff*/)>>n)|((!(!(x&(1<<31))))<<32+~n);
    }
/*************************************************************************************************/
/*
 ...
 */
/*************************************************************************************************/
//inspirqtion https://github.com/Poohblah/csci2400-datalab/blob/master/bits.c
int func7(int x) 
    {
      x=x^(x >> 16);
      x=x^(x >> 8);
...
int func9(int x) 
    {
      return !((((x+1)+x)+1)+!(x+1));//!(x^0x7fffffff);
    }
/*************************************************************************************************/
/* 
 * func10 - return -x 
...
int func11(int x, int y) 
    {
     //we have overflow if x and y have the same sign but the sign of x+y is different 
      return  !(((~(x^y)) & ((x+y)^x))&(1<<31));
    }
/*************************************************************************************************/
/* 
...
int func12(int x) 
    {
      return !((x&(1<<31)) | !x);;//!((((!x)<<31)+x&0x80000000)>>31);//!((x&0x80000000)>>31);
    }
/*************************************************************************************************/
/*
 ...
 */
/*************************************************************************************************/
//inpiration in https://github.com/AnanyaKumar/computer-systems-class/blob/master/datalab.c
int func13(int x, int y) 
    {
     return 
	 ((x+y) & (~(((~(x^y)) & ((x+y)^x))>>31))) 
	 | 
	 ( (((1<<31) + ((x+y)>>31))) & (((~(x^y)) & ((x+y)^x))>>31));
	}
/*************************************************************************************************/
